module.exports = {
    name: "play",
    cooldown: 3,
    description: 'تشغيل اغنية/قائمة اغاني',
    aliases: ["p"],
        ...
        try {
            ...
            if (!permissions.has('CONNECT') || !permissions.has('SPEAK')) {
                message.channel.send({
                    embed: {
                        title: `❌ |خطأ`,
                        description: `يحتاج الروبوت إلى الأذونات نفسها لتشغيل موسيقى مثل \`اتصال\`, \`تحدث\``,
                        color: 0xF70000
                    }
                });
                return
            ...
            if (!args.length) {
                message.channel.send({
                    embed: {
                        title: `❌ |خطأ`,
                        description: `يجب عليك كتابة الأغنية <name / url> بعد الأمر`,
                        color: 0xF70000
                    }
                });
                return
...
//             embed: {
//                 title: `❌ |خطأ`,
//                 description: `There was an aخطأ in the connection`,
//                 color: 0xF70000
//             }
//         });
//         throw err;
